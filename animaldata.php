...
<html>
  <head>
    ...
    <title> Sistem Pendukung Keputusan (DSS-SAW) Penentuan Lokasi Peternakan | Data Hewan</title>
  ...
  <?php
    ...
    $sql_selecthewan = mysqli_query($connect_db, "SELECT * FROM tb_animaldata");
  ?>
              ...
              <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu" role="menu">
                    <li  class="active"><a href="#"><i class="fa fa-paw"></i><span>Data Hewan</span></a></li>
    ...
    <section class="content container-fluid">
        ...
        <div class="box box-solid">
          <div class="box-header with-border">
            <h3 class="box-title"><i class="fa fa-list-ul"></i> Data hewan yang digunakan.</h3>
          </div>
          <div class="box-body">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#tab_hew" data-toggle="tab"> Hewan </a></li>
            </ul>
            <div class="tab-content">
              <div class="tab-pane active" id="tab_hew">
              <br>Setiap hewan yang digunakan memiliki batas bawah & akhir suhu. Dengan menggunakan batas bawah & akhir ini akan menjadi salah satu pertimbangan pemilihan lokasi dari suhu.<br><br>
                <table class="table table-bordered table-striped">
                  <thead>
                    <th> ID Hewan </th>
                    <th> Nama Hewan </th>
                    <th> Batas Bawah Suhu (°C) </th>
                    <th> Batas Atas Suhu (°C) </th>
                  </thead>
                  <tbody>
                    <?php
                      while ($row = mysqli_fetch_assoc($sql_selecthewan)) 
                      {
                        echo "<tr>\n";
                        foreach($row as $td) 
                        {
