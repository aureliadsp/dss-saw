...
<html>
  <head>
    ...
    <title> Sistem Pendukung Keputusan (DSS-SAW) Penentuan Lokasi Peternakan | Data Lokasi</title>
  ...
  <?php
    ...
    $sql_selectlocall = mysqli_query($connect_db, "SELECT * FROM tb_locationdata");
    $sql_selectwaterall = mysqli_query($connect_db, "SELECT * FROM tb_waterdata");
    $sql_selectfodall = mysqli_query($connect_db, "SELECT * FROM tb_fodderdata");
    $sql_selectmoball = mysqli_query($connect_db, "SELECT * FROM tb_mobilitydata");
  ?>
              ...
              <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu" role="menu">
                    ...
                    <li  class="active"><a href="#"><i class="fa fa-location-arrow"></i><span>Data Lokasi</span></a></li>
                  </ul>
                </li>
              </ul>
            </div>
    ...
    <section class="content container-fluid">
        ...
        <div class="box box-solid">
          <div class="box-header with-border">
            <h3 class="box-title"><i class="fa fa-location-arrow"></i> Data lokasi yang telah dikumpulkan dari survey lapangan.</h3>
          </div>
          <div class="box-body">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#tab_all" data-toggle="tab"> Lokasi </a></li>
              <li><a href="#tab_water" data-toggle="tab"> Keadaan Air</a></li>
              <li><a href="#tab_fod" data-toggle="tab"> Keadaan Pakan</a></li>
            ...
            <div class="tab-content">
              <div class="tab-pane active" id="tab_all">
                <table class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
                      while ($row = mysqli_fetch_assoc($sql_selectlocall)) 
                      {
                        echo "<tr>\n";
                        foreach($row as $td) 
                        {
              ...
              <!-- /.tab-pane -->
              <div class="tab-pane" id="tab_water">
                <table class="table table-bordered table-striped">
                <br> Tabel di bawah menunjukkan keadaan air di masing - masing lokasi. <br>Nilai <b>0</b> menunjukkan <b>Tidak</b>, dan nilai <b>1</b> menunjukkan <b>Ya</b>.<br><br>
                  <thead>
                    <th> ID Lokasi </th>
                    <th> Ketersediaan air dalam jangka lama </th>
                    <th> Bebas dari polusi</th>
                    <th> Bebas dari mikroorganisme </th>
                    <th> Kompetisi air dengan manusia </th>
                    <th> Score total </th>
                    <th> Status </th>
                  </thead>
                  <tbody>
                   <?php
                      while ($row = mysqli_fetch_assoc($sql_selectwaterall)) 
                      {
                        echo "<tr>\n";
                        foreach($row as $td) 
                        {
              ...
              <!-- /.tab-pane -->
              <div class="tab-pane" id="tab_fod">
                <br> Tabel di bawah menunjukkan keadaan air di masing - masing lokasi. <br> Nilai <b>0</b> menunjukkan <b>Tidak</b>, dan nilai <b>1</b> menunjukkan <b>Ya</b>.<br><br>
                <table class="table table-bordered table-striped">
                  <thead>
                    <th> ID Lokasi </th>
                    <th> Adanya lahan menggembala </th>
                    <th> Adanya pakan hijau </th>
                    <th> Adanya pakan pengganti </th>
                    <th> Keadaan dari pakan </th>
                    <th> Score total </th>
                    <th> Status </th>
                  </thead>
                  <tbody>
                   <?php
                      while ($row = mysqli_fetch_assoc($sql_selectfodall)) 
                      {
                        echo "<tr>\n";
                        foreach($row as $td) 
                        {
              ...
              <div class="tab-pane" id="tab_mob">
                ...
                <table class="table table-bordered table-striped">
                  <thead>
                    <th> ID Lokasi </th>
                    <th> Keadaan akses </th>
                    <th> Akses jalan luas </th>
                    <th> Lokasi jauh dari kota besar </th>
                  ...
                  <tbody>
                   <?php
                      while ($row = mysqli_fetch_assoc($sql_selectmoball)) 
                      {
                        echo "<tr>\n";
                        foreach($row as $td) 
                        {
