    ...
    <div id="wrap">
        ...
        <?php
            ...
            if(isset($_GET['email']) && !empty($_GET['email']) AND isset($_GET['hash']) && !empty($_GET['hash']))
            {
                ...
                $search = mysqli_query("SELECT email, hash, active FROM tb_userdata WHERE email='".$email."' 
                ...
                if($match > 0)
                {
                    ...
                    mysqli_query("UPDATE tb_userdata SET active='1' WHERE email='".$email."' AND hash='".$hash."' 
